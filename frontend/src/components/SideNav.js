        ...
        <StNavMenuBox>
            <StNavMenuItem>
                <Link to='/main' className="linkSideNav">
                    <HiHome/><StNavMenuItemSpan>홈</StNavMenuItemSpan>
                </Link>
            </StNavMenuItem>
            <StNavMenuItem>
                <Link to='/main' className="linkSideNav">
                    <HiOutlinePaperAirplane/><StNavMenuItemSpan>메세지</StNavMenuItemSpan>
                </Link>
            </StNavMenuItem>
            <StNavMenuItem>
                <Link to='/main' className="linkSideNav">
                    <FaRegHeart/><StNavMenuItemSpan>알림</StNavMenuItemSpan>
                </Link>
            </StNavMenuItem>
            <StNavMenuItem>
                <Link to='/main' className="linkSideNav">
                    <FiPlusSquare/><StNavMenuItemSpan>만들기</StNavMenuItemSpan>
                </Link>
            </StNavMenuItem>
            <StNavMenuItem>
                <Link to='/main' className="linkSideNav">
                    <CgProfile/><StNavMenuItemSpan>프로필</StNavMenuItemSpan>
                </Link>
            </StNavMenuItem>
            <StNavMenuItemWarning onClick={onClickLogout}>
                <HiOutlineLogout/><StNavMenuItemSpan>로그아웃</StNavMenuItemSpan>
